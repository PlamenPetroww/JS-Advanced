class VegetableStore {
    ...
    loadingVegetables(vegetables) {
        ...
        this.availableProducts.forEach(product => { buffer.push(product.type) });

        return `Successfully added ${buffer.join(', ')}`;
    }
    ...
    revision () {
        ...
        .forEach(product => buff += `${product.type}-${product.quantity}-$${product.price}\n`);
